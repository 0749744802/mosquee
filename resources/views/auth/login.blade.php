                        ...
                        <div class="card mt-4 card-bg-fill">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Coonecter vous pour administrer le site.</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" id="email" name="email" class="form-control" id="username" placeholder="Enter username">
                                        ...
                                        <div class="mb-3">
                                            <div class="float-end">
                                                ...
                                                <a href="{{ route('password.request') }}" class="text-muted">Mot de passe oublier?</a>
                                                @endif
                                            </div>
                                            <label class="form-label" for="password-input">Mot de passe</label>
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="password" id="password" class="form-control pe-5 password-input" placeholder="Enter password" name="password"  required autocomplete="current-password">
