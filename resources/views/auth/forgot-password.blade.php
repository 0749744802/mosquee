...
<head>
    ...
    <meta charset="utf-8" />
    <title>Logiciel | Mot de passe oublier</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">je me souvient de mont mot de passe... <a href="login" class="fw-semibold text-primary text-decoration-underline"> Click ici </a> </p>
                        </div>
