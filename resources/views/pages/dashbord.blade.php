                                    ...
                                    <div class="col-12">
                                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="text-muted mb-0">Bienvenue a vous.</p>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <p class="text-uppercase fw-medium text-muted  mb-0"> Total demande devis</p>
                                                    </div>
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="{{ $count_devi }}">0</span>Devis </h4>
                                                        <a href="liste_devis" class="text-decoration-underline">Liste des devis</a>
                                                    </div>
